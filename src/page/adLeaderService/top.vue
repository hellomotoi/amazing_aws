...
<script>
  ...
  import {serviceInfo, activeTask} from '../../service/getData.js'
  ...
  export default{
    ...
    methods   : {
      ...
      changeBtnShow() { // 转单
        const showStatusArr = ['stepOne', 'stepTwo', 'stepThree', 'stepFour', 'stepFive', 'stepEight', 'stepNine', 'stepTen'];
      ...
      lostBtnShow() { // 丢单
        const showStatusArr = ['stepEight', 'stepNine', 'stepTen'];
        if(this.roleId == 4 && showStatusArr.indexOf(this.orderInfo.statusType) != -1){
          return true;
        }
        return false;
