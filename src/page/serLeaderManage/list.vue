...
<script>
  ...
  import {getTaskDayType, getServiceMemberList} from '../../service/getData.js'
  ...
  export default {
    data(){
      return {
        ...
        endDate        : '',
        datePickerValue: '',
        currentStatus: 'customerLeader', // collectCount-线索分析；customerLeader-客服leader下属成员管理；plannerLeader-顾问leader下属成员管理
        currentType  : '', // 当前选中场景
        typeList : [],
        tableTitle     : {},
        tableData      : [], // 表格数据
    ...
    methods : {
      ...
      getList() {
        ...
        getServiceMemberList(params).then(res => {
          this.loading = false;
